...
const buttonVariants = cva(
	"inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none uppercase tracking-wide",
	{
		variants: {
			variant: {
				locked: "bg-neutral-200 text-primary-foreground hover:bg-nmeutral-200/90 border-neutral-400 border-b-4 active:border-b-0",
				default:
				...
				sidebar:
					"bg-transparent text-stale-100 border-2 border-transparent hover:bg-slate-100 transition-none",
				sidebarOutline:
